...
# Docker places the custom class beside app.py; locally it stays in notebooks/.
for module_dir in [APP_DIR, PROJECT_ROOT / "notebooks"]:
...
A1_PATH = first_existing_path(
    APP_DIR / "models" / "car_price_prediction_a1.joblib",
    PROJECT_ROOT / "models" / "car_price_prediction_a1.joblib",
)
A2_PATH = first_existing_path(
    APP_DIR / "models" / "best_a2_model.joblib",
    PROJECT_ROOT / "models" / "best_a2_model.joblib",
)
